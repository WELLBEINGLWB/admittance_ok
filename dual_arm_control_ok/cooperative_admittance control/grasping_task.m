...
% [xa_d,dxa_d,ddxa_d,xr_d,dxr_d,ddxr_d,grasp_data] = traj_gen(xa_in,xr_in,time);
[xa_d,dxa_d,ddxa_d,xr_d,dxr_d,ddxr_d,grasp_data] = grasp_traj(xin_1,xin_2,time);   
...
while sim.simxGetConnectionId(clientID)~=-1
    ...
    [wr_1,wr_2] = wrench_ext(x1,x2,grasp_data(i,:));
